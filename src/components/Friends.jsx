...
export default function Friends() {
  return (
    <section className="wrapper style1" id="friends">
      <style>{`
        .friends-row {
          display: flex;
          flex-direction: row;
        ...
        .friends-row::-webkit-scrollbar-thumb {
        ...
        .friend-photo-placeholder { font-size: 2.2em; color: #aaa; line-height: 1; user-select: none; }
